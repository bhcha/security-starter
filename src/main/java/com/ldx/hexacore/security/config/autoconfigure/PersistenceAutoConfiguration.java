...
import com.ldx.hexacore.security.session.adapter.outbound.event.SessionEventPublisherConfiguration;
import com.ldx.hexacore.security.session.adapter.outbound.memory.InMemorySessionConfiguration;
import com.ldx.hexacore.security.session.adapter.outbound.persistence.SessionPersistenceConfiguration;
...
public class PersistenceAutoConfiguration {
    ...
    @Import({
        AuthenticationPersistenceConfiguration.class,
        SessionPersistenceConfiguration.class,
        SessionEventPublisherConfiguration.class,
        AuthenticationEventConfiguration.class
    })
    ...
    @Import({
        InMemoryAuthenticationConfiguration.class,
        InMemorySessionConfiguration.class,
        SessionEventPublisherConfiguration.class,
        AuthenticationEventConfiguration.class
    })
